...
(function() {
	...
	const apiKey = "5da60e8aff110333a8ecea4ee7430758"; // Replace "APIKEY" with your own API key; otherwise, your HTTP request will not work
	const activities = {
...
//		ReactDOM.render(<Forecast {...state} />, $into);
	...
	function updateActivityList(event) {
		if (event !== undefined && $(this).hasClass('selected')) {
			...
			document.querySelectorAll('.option div').forEach(function(el){
